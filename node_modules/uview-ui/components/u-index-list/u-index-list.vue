<template>
	<view class="u-index-list">
		...
		<list
			...
			:offset-accuracy="1"
			:style="{
				maxHeight: $u.addUnit(scrollViewHeight * 2)
			}"
		...
		<view
			...
			:style="{ top: $u.addUnit(letterInfo.top * 2 || 100) }"
		...
		>
			<view
				...
				:style="{
					height: $u.addUnit(indicatorHeight * 2),
					width: $u.addUnit(indicatorHeight * 2)
				}"
			>
